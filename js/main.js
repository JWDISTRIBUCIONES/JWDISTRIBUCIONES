const products = [
  ...
  {name: "Shampoo + Tratamiento Repolarizador Zanahoria & Aguacate (1000ml)", cat: "Tratamientos", img: "imagen0.jpeg", desc: "Estimula el cuero cabelludo, nutre, combate la resequedad y puntas abiertas. Elaborado con jojoba, otoba y aceites naturales. 100% Natural."},
  {name: "Shampoo + Tratamiento Nutritivo Banano & Miel (1000ml)", cat: "Tratamientos", img: "imagen0.jpeg", desc: "Explosión de vitaminas capilar a base de colágeno, keratina, células madres, aloe vera, placenta, miel, biotina y argán."},
  {name: "Shampoo + Tratamiento Reparador Coco & Argán (1000ml)", cat: "Tratamientos", img: "imagen0.jpeg", desc: "A base de coco, argán y leche de almendras. Nutrición, brillo y estímulo para el crecimiento capilar."},
  {name: "Shampoo + Tratamiento Hidratante Células Madres (1000ml)", cat: "Tratamientos", img: "imagen0.jpeg", desc: "Limpia, suaviza y restaura daños ocasionados por agentes externos con aloe vera y aguacate."},
  ...
  {name: "Aceite Capilar Argán Nutribell", cat: "Aceites", img: "imagen0.jpeg", desc: "Hidrata, regenera y repara puntas abiertas retrasando el envejecimiento capilar."},
  {name: "Decolorante en Polvo Perfect Blond Belotti (450g)", cat: "Coloracion", img: "imagen0.jpeg", desc: "Polvo decolorante blanco con alto poder de aclaración. Mantiene la suavidad del cabello."},
